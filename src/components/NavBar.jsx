import { BsCart3, BsMoonFill, BsNvidia, BsSunFill } from 'react-icons/bs';
        ...
        <div className='navbar align-element'>
            <div className="navbar-start">
                ...
                <div className="dropdown ">
                    ...
                    <ul tabIndex={0} className='menu dropdown-content menu-sm mt-3 z-[1] p-2 shadow bg-base-200 rounded-box w-53'>
                        <NavLinks/>
                    </ul>
                </div>
            </div>
